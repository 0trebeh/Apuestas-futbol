  ...
  async sendMail(username: string, email: string) {
    try {
      await this.transporter.sendMail({
        ...
        text:
          'Mira la información de tus jugadores, equipos y torneos favoritos, encontraras estadísticas relevantes con los ultimos algoritmos especializados que te darán probabilidades sumamente precisas.' +
